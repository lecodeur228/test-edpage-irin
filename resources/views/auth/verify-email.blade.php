...
@section('title', __('auth.email_verification'))
        ...
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    {{ $alreadyVerified ? __('auth.email_already_verified') : __('auth.email_verified_successfully') }}
                </h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                {{ $alreadyVerified ? __('auth.email_already_verified_text') : __('auth.email_verified_successfully_text') }}
            </p>
